...
let message="Hello! Welcome to Art Gallery!";
// const k=document.cookie;
try{
    window.alert(`${message} Your Lucky Number is: ${num}`);
...
const openwindow=()=>{
    myWindow=window.open("https://en.wikipedia.org/wiki/Art_gallery","","width:400,height:400");
}
const closewindow=()=>{
    myWindow.close();
}